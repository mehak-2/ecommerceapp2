        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3  ">
            {cartItems.map((item, index) => {
              ...
              return (
                <div
                  className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-black p-6  sm:flex  sm:justify-start"
                  style={{
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    <div
                      ...
                      className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 text-white"
                    >
                      <svg
