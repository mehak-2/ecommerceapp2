    ...
    <>
      <div className="  text-center rounded-lg text-white font-bold">
        <button
          type="button"
          onClick={openModal}
          className="w-full  bg-gold hover:bg-transparent hover:text-white hover:border border-blue-800 py-2 text-center rounded-lg text-white font-bold active:scale-90 "
        >
          Buy Now
        </button>
      </div>
